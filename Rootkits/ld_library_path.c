#include <stdiorunpayloauh>
#include <stdlib.h>
#include <unistd.h>

// export LD_LIBRARY_PATH=/home/offsec/ldlib
// mkdir /home/offsec/ldlib
// gcc -Wall -fPIC -c -o library.o library.c
// gcc -shared -Wl,--version-script gpg.map -o /home/offsec/ldlib/libgpg-error.so.0 library.o
// sudo top
